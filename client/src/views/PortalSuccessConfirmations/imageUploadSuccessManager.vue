<template>
  <div class="container" style="margin-top: 20%">
    <h1 class="title has-text-centered">Hospital image changed successfully, changes may take a few minutes to hours to
      take effect.</h1>
    <br />
...
export default {
  ...
  created() {
    setTimeout(() => {
      ...
      this.$store.commit('imgSuccessManager', false)
    }, 15000)
  }
}
</script>
