    ...
    <section class="section">
        ...
        <div class="container box" style="width: 33%">
            ...
            <div
                ...
                v-if="success"
            >Your problem has been reported, your ticket ID is: {{ ticketID }}. Please see your email for further instructions.</div>
            <div v-else>
                ...
                <div class="dropdown is-hoverable block">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-content">
                            <a
                                class="dropdown-item"
                                @click="ticketType = 'General Inquiry'"
                            >General Inquiry</a>
                            <a
                                class="dropdown-item"
                                @click="ticketType = 'Account Problem'"
                            >Account Problem</a>
                            <a
                                class="dropdown-item"
                                @click="ticketType = 'Report a bug'"
                            >Report a bug</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="field has-text-centered">
                    <div class="control">
                        <button
                            ...
                            @click="submitIssue"
                            :disabled="ticketType == '' || email == '' || title == '' || message == ''"
                        >Submit Issue</button>
                    </div>
                </div>
            </div>
